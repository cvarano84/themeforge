...
reported to the maintainer using GitHub's
[report content](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam)
tools, or — for anything sensitive — privately via the repository's
[Security tab](https://github.com/Themearr/themearr/security/advisories/new).
